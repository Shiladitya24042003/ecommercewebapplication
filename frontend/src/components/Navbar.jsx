...
function Navbar() {
    ...
    return (
        <div className={`max-w-screen-4xl container mx-auto md:px-20 px-4 md:py-1 z-50 fixed top-0 right-0 left-0 ${sticky ? "sticky-navbar shadow-md colours duration-200 transition-all ease-in-out" : ""}`}>
                    ...
                    <div className="dropdown dropdown-end px-2">
                        <Link to="/cart" className="btn btn-ghost btn-circle">
                            <div className="indicator">
                                ...
                                <span className="badge badge-sm bg-red-500 indicator-item">{totalItems}</span>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="navbar-end flex items-center">
                        {
                            authUser ? <Logout /> :
                                ...
                                (<div className="px-3">
                                    <a className="className='mx-4 px-3 py-2 bg-transparent border border-red-500 text-red-500 rounded-full hover:bg-pink-500 hover:text-white hover:shadow-pink-500/50 shadow-none transition-all duration-300 ease-in-out'"
